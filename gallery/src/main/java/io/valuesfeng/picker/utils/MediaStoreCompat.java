    ...
    public String invokeCameraCapture(Activity activity, int requestCode) {
        if(!hasCameraFeature(this.mContext)) {
            ...
            if(toSave == null) {
                ...
                String path = Environment.getExternalStorageDirectory()+"/Android/data/com.canplay.medical/files/";
                Intent intent = new Intent("android.media.action.IMAGE_CAPTURE");
                intent.addCategory("android.intent.category.DEFAULT");
                Uri uriForFile = FileProvider.getUriForFile(activity, "com.canplay.medical.fileProvider", toSave);
